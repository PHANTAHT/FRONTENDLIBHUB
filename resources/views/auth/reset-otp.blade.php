...
<div class="grid min-h-screen lg:grid-cols-2">
  <div class="relative hidden overflow-hidden bg-maroon lg:block">
    ...
    <div class="relative flex h-full flex-col justify-between p-12">
      ...
      <div>
        <h2 class="font-display text-4xl font-semibold leading-tight text-cream">Cek email kamu.</h2>
        <p class="mt-4 max-w-sm text-cream/70">Masukkan kode 6 digit untuk melanjutkan penggantian kata sandi.</p>
      </div>
  ...
  <div class="flex items-center justify-center px-6 py-12">
    <div class="w-full max-w-sm">
      ...
      <h1 class="font-display text-3xl font-semibold text-maroon">Verifikasi Kode</h1>
      <p class="mt-2 text-sm text-ink/60">Kode dikirim ke<br><span class="font-semibold text-maroon">{{ $email }}</span></p>
